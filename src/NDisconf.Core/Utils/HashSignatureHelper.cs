...
namespace NDisconf.Core.Utils
{
    ...
    public class HashSignatureHelper
    {
        ...
        /// <returns></returns>
        public static string SignData(string content, string algorithm, string encodingName = "UTF-8")
        {
        ...
        /// <param name="algorithm">算法名称</param>
        /// <returns></returns>
        public static byte[] SignData(byte[] content, string algorithm)
        {
        ...
        /// <param name="encodingName">编码方式</param>
        /// <returns></returns>
        public static bool VerifyData(string content, string signature, string algorithm, string encodingName = "UTF-8")
        {
        ...
        /// <param name="algorithm">算法名称</param>
        /// <returns></returns>
        public static bool VerifyData(byte[] content, byte[] signature, string algorithm)
        {
