...
namespace NDisconf.Core.Utils
{
    ...
    public class TripleDESHelper : SymmetricAlgorithmHelper<TripleDESCryptoServiceProvider>
    {
        ...
        {
            SymmetricAlgorithmHelper<TripleDESCryptoServiceProvider>.Create(out key, out iv, keySize);
        }
    }
    /// <summary>
    /// AESHelper
    ...
    public class AESHelper : SymmetricAlgorithmHelper<AesCryptoServiceProvider>//RijndaelManaged
    {
        ...
        {
            SymmetricAlgorithmHelper<AesCryptoServiceProvider>.Create(out key, out iv, keySize);
        }
    }
    /// <summary>
    /// DESHelper
    ...
    public class DESHelper : SymmetricAlgorithmHelper<DESCryptoServiceProvider>
    {
        ...
        {
            SymmetricAlgorithmHelper<DESCryptoServiceProvider>.Create(out key, out iv, keySize);
        }
    }
    /// <summary>
    /// RC2Helper
    ...
    public class RC2Helper : SymmetricAlgorithmHelper<RC2CryptoServiceProvider>
    {
        ...
        {
            SymmetricAlgorithmHelper<RC2CryptoServiceProvider>.Create(out key, out iv, keySize);
        }
    }
}
